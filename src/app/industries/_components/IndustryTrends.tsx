...
export type Trend = { number: string; title: string; body: string };

// Numbered "trends / advanced technologies" grid shared across industry
// pages. Same bordered grid as IndustryFeatures but with a number instead
// of the asterisk glyph.
