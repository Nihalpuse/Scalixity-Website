...
// Fintech-specific cohorts for the shared landing <Services /> section:
// same component, cards, hover-video, and sticky left-rail — Research /
// Design / Development grouping and copy from the fintech page.
export const FINTECH_SERVICE_COHORTS: Cohort[] = [
  {
    key: "research",
    label: "Research",
    title: "Service-driven discovery for fintech teams",
    services: [
      {
        number: "01",
  ...
  },
  {
    key: "design",
    label: "Design",
    title: "Creating fintech interfaces that convert",
    services: [
      {
        number: "01",
  ...
  },
  {
    key: "development",
    label: "Development",
    title: "End-to-end execution for fintech launch and growth",
    services: [
      {
        number: "01",
