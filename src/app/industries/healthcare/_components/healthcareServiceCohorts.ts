...
// Healthcare-specific cohorts for the shared landing <Services /> section:
// same component, cards, hover-video, and sticky left-rail — Research /
// Design / Development grouping and copy from the healthcare page.
export const HEALTHCARE_SERVICE_COHORTS: Cohort[] = [
  {
    key: "research",
    label: "Research",
    title: "Solid groundwork for scalable medical products",
    services: [
      {
        number: "01",
  ...
  },
  {
    key: "design",
    label: "Design",
    title: "Interfaces that support real healthcare workflows",
    services: [
      {
        number: "01",
  ...
  },
  {
    key: "development",
    label: "Development",
    title: "Code that powers real healthcare products",
    services: [
      {
        number: "01",
